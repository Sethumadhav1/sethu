...
import { AppBar, Toolbar, Typography, Container, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button, Box, Modal, Grid2, Grid, Tab, Tabs } from '@mui/material';
...
// const tickets = [
//     { id: 'INC1388672', type: 'incident', priority: 'P4', status: 'Resolved', createdDate: '2025-01-31 16:44', category: 'Network' },
//     { id: 'INC6977684', type: 'incident', priority: 'P4', status: 'Resolved', createdDate: '2025-01-31 13:46', category: 'Network' },
//     { id: 'INC5060711', type: 'incident', priority: 'P4', status: 'Resolved', createdDate: '2025-01-30 19:58', category: 'Network' },
//   ];
...
export default function LTwo() {
    ...
    useEffect(() => {
      const fetchTickets = async () => {
        try {
          const data = await getTickets({ level: 'L2' });
          console.log(tickets)
